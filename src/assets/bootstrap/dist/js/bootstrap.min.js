...
!function (t, e) {
  ...
  var v = "button", y = "bs.button", E = "." + y, C = ".data-api", T = g.fn[v], S = "active",
    b = "btn", I = "focus", D = '[data-toggle^="button"]', w = '[data-toggle="buttons"]',
  ...
  var L = "carousel", j = "bs.carousel", H = "." + j, R = ".data-api", x = g.fn[L],
    ...
    rt = "[data-slide], [data-slide-to]", st = '[data-ride="carousel"]',
  ...
  var ct = "collapse", ht = "bs.collapse", ut = "." + ht, ft = g.fn[ct],
    dt = {toggle: !0, parent: ""}, gt = {toggle: "boolean", parent: "(string|element)"}, _t = {
      SHOW: "show" + ut,
      SHOWN: "shown" + ut,
      HIDE: "hide" + ut,
      HIDDEN: "hidden" + ut,
  ...
  var It = "dropdown", Dt = "bs.dropdown", wt = "." + Dt, At = ".data-api", Nt = g.fn[It],
    ...
    Kt = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Qt = "top-start",
  ...
  var Zt = "modal", te = "bs.modal", ee = "." + te, ne = g.fn[Zt],
    ...
    }, se = "modal-dialog-scrollable", ae = "modal-scrollbar-measure", le = "modal-backdrop",
    ce = "modal-open", he = "fade", ue = "show", fe = ".modal-dialog", de = ".modal-body",
    ge = '[data-toggle="modal"]', _e = '[data-dismiss="modal"]',
  ...
  var be = "tooltip", Ie = "bs.tooltip", De = "." + Ie, we = g.fn[be], Ae = "bs-tooltip",
    Ne = new RegExp("(^|\\s)" + Ae + "\\S+", "g"), Oe = ["sanitize", "whiteList", "sanitizeFn"],
    ke = {
      animation: "boolean",
      template: "string",
    ...
    }, xe = "fade", Fe = "show", Ue = ".tooltip-inner", We = ".arrow", qe = "hover", Me = "focus",
    Ke = "click", Qe = "manual", Be = function () {
      function i(t, e) {
      ...
      return t.enable = function () {
        ...
        var e = this, n = this.getTipElement(), i = g.Event(this.constructor.Event.HIDE),
          o = function () {
  ...
  var an = "scrollspy", ln = "bs.scrollspy", cn = "." + ln, hn = g.fn[an],
    ...
    fn = {offset: "number", method: "string", target: "(string|element)"}, dn = {
      ACTIVATE: "activate" + cn,
      SCROLL: "scroll" + cn,
      LOAD_DATA_API: "load" + cn + ".data-api"
    }, gn = "dropdown-item", _n = "active", mn = '[data-spy="scroll"]', pn = ".nav, .list-group",
    vn = ".nav-link", yn = ".nav-item", En = ".list-group-item", Cn = ".dropdown",
    Tn = ".dropdown-item", Sn = ".dropdown-toggle", bn = "offset", In = "position",
    Dn = function () {
      function n(t, e) {
        var n = this;
  ...
  var wn = "bs.tab", An = "." + wn, Nn = g.fn.tab, On = {
    ...
    }, kn = "dropdown-menu", Pn = "active", Ln = "disabled", jn = "fade", Hn = "show",
    Rn = ".dropdown", xn = ".nav, .list-group", Fn = ".active", Un = "> li > .active",
  ...
  var Qn = "toast", Bn = "bs.toast", Vn = "." + Bn, Yn = g.fn[Qn], zn = {
    ...
    ti = {animation: !0, autohide: !0, delay: 500}, ei = '[data-dismiss="toast"]',
    ni = function () {
      function i(t, e) {
