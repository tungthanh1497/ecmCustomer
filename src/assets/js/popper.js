...
(function (e, t) {
  ...
  function d(e, t) {
    ...
    var o = e.compareDocumentPosition(t) & Node.DOCUMENT_POSITION_FOLLOWING, i = o ? e : t,
      n = o ? t : e, a = document.createRange();
  ...
  function l(e, t) {
    var o = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = a(t, 'top'),
      n = a(t, 'left'), r = o ? -1 : 1;
  ...
  function g(e) {
    ...
    var r = {left: o.left, top: o.top, width: o.right - o.left, height: o.bottom - o.top},
      ...
      d = p.height || e.clientHeight || r.bottom - r.top, l = e.offsetWidth - s,
      m = e.offsetHeight - d;
    if (l || m) {
      var g = t(e);
  ...
  function b(e) {
    var t = window.document.documentElement, o = u(e, t),
      i = X(t.clientWidth, window.innerWidth || 0), n = X(t.clientHeight, window.innerHeight || 0),
      r = a(t), p = a(t, 'left'),
  ...
  function G(e, t, o, i) {
    var n = [0, 0], r = -1 !== ['right', 'left'].indexOf(i),
    ...
    placement: 'bottom', eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
      ...
      shift: {
        order: 100, enabled: !0, fn: function (e) {
          ...
          if (i) {
            var n = e.offsets, r = n.reference, p = n.popper,
      ...
      keepTogether: {
        order: 400, enabled: !0, fn: function (e) {
          var t = e.offsets, o = t.popper, i = t.reference, n = e.placement.split('-')[0], r = _,
            p = -1 !== ['top', 'bottom'].indexOf(n), s = p ? 'right' : 'bottom',
      ...
      arrow: {
        order: 500, enabled: !0, fn: function (e, o) {
          ...
          var n = e.placement.split('-')[0], r = e.offsets, p = r.popper, s = r.reference,
            d = -1 !== ['left', 'right'].indexOf(n), a = d ? 'height' : 'width',
            l = d ? 'Top' : 'Left', f = l.toLowerCase(), m = d ? 'left' : 'top',
            c = d ? 'bottom' : 'right', g = O(i)[a];
      ...
      computeStyle: {
        order: 850, enabled: !0, fn: function (e, t) {
          ...
          var s, d, a = void 0 === p ? t.gpuAcceleration : p, l = r(e.instance.popper), f = g(l),
            ...
            h = 'bottom' === o ? 'top' : 'bottom', u = 'right' === i ? 'left' : 'right',
            b = B('transform');
