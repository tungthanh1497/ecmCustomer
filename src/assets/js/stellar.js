...
(function (e, t, n, r) {
  ...
  d.prototype = {
    init: function () {
      ...
      var t = this, n = o[t.options.scrollProperty], r = u[t.options.positionProperty],
        i = n.setLeft, s = n.setTop;
...
(function (d, f, g, b) {
  ...
  var e = "parallax", c = {on: "scroll", listenTo: f, sceneMode: false}, a = d(f), i = 0;
  ...
  d.extend(h.prototype, {
    init: function () {
      ...
      var k = a.scrollTop(), n = k + a.height(), j = o.offset().top, m = j + o.height();
      if (l === true) {
        return k <= j && n >= m
      }
      return !(k > m || n < j)
