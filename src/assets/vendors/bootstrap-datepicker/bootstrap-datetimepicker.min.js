(function (a) {
  ...
  g.prototype = {
    constructor: g, _events: [], _attachEvents: function () {
      ...
      var E = new Date(this.viewDate), t = E.getUTCFullYear(), G = E.getUTCMonth(),
        n = E.getUTCDate(), A = E.getUTCHours(), w = this.startDate.getUTCFullYear(),
        B = this.startDate.getUTCMonth(), p = this.endDate.getUTCFullYear(),
      ...
      var m = new Date(this.viewDate), k = m.getUTCFullYear(), l = m.getUTCMonth(),
        j = m.getUTCDate(), i = m.getUTCHours();
  ...
  var c = {
    ...
    parseDate: function (A, y, v, j, r) {
      ...
      var q = A && A.toString().match(this.nonpunctuation) || [], A = new Date(0, 0, 0, 0, 0, 0, 0),
        m = {},
